...
import { useBuinessCardContract } from '../hooks/useBuisnessCardContracts';


export function BusinessCard() {

  const { likes, userInfo, sendLike } = useBuinessCardContract()
    ...
    <div className='container'>
      ...
      <div className='sub-container'>
        ...
        <div className="like-container">
          <FontAwesomeIcon icon={faHeart} onClick={sendLike} className="heart-icon" />
          &nbsp;<span>{likes}</span>
        </div>
